...
namespace ot
{
    ...
    class MatCompactRows
    {
      ...
      protected:
        ...
        size_t m_maxAllowedRows;
      public:
        MatCompactRows() = delete;
        MatCompactRows(unsigned int npe, unsigned int ndofs,const size_t maxAllowedRows)
          : m_npe(npe), m_ndofs(ndofs),m_maxAllowedRows(maxAllowedRows)
        {
        ...
        size_t       getmaxAllowedRows()   const { return m_maxAllowedRows; }
