#!/bin/bash
#SBATCH --time=0:02:00     # walltime, abbreviated by -t
...
#SBATCH --job-name=matvec_bench_channel-weak2048_p1
...
ELE_ORDER=1
ibrun -n 1024 $RUNPROGRAM $PTS_PER_PROC_WEAK $MAX_DEPTH $ELE_ORDER "weak_p1" > "out-${SLURM_JOB_ID}-weak_p1-np1024-2048.tsv"
ibrun -n 2048 $RUNPROGRAM $PTS_PER_PROC_WEAK $MAX_DEPTH $ELE_ORDER "weak_p1" >> "out-${SLURM_JOB_ID}-weak_p1-np1024-2048.tsv"
