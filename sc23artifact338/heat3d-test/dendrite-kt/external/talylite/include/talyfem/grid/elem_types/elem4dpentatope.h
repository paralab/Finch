...
*/
// --- end license text --- //
#ifndef GRID_ELEM_TYPES_ELEM4DPENTATOPE_H_
#define GRID_ELEM_TYPES_ELEM4DPENTATOPE_H_
...
/**
 * 4D pentatope element.
 */
class ELEM4dPentatope : public ELEM {
 public:
  ElemType elmType() const override { return kElem4dPentatope; }
  int GetNodesPerSurface() const override;
  const int* GetSurfaceCheckArray() const override;
  int GetSurfaceCount() const override { return 5; } ///< 5 choose 4
...
#endif  // GRID_ELEM_TYPES_ELEM4DPENTATOPE_H_
