...
*/
// --- end license text --- //
#ifndef GRID_ELEM_TYPES_ELEM2DTRIANGLE_H_
#define GRID_ELEM_TYPES_ELEM2DTRIANGLE_H_
 ...
 * 2D triangle element.
 */
class ELEM2dTriangle : public ELEM {
 public:
  ElemType elmType() const override { return kElem2dTriangle; }
  int GetNodesPerSurface() const override;
  const int* GetSurfaceCheckArray() const override;
  int GetSurfaceCount() const override { return 3; }
...
#endif  // GRID_ELEM_TYPES_ELEM2DTRIANGLE_H_
