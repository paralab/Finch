...
*/
// --- end license text --- //
#ifndef TESTS_PERIODICEXCHANGE_INCLUDE_PBC_INPUT_DATA_H_
#define TESTS_PERIODICEXCHANGE_INCLUDE_PBC_INPUT_DATA_H_
...
#endif  // TESTS_PERIODICEXCHANGE_INCLUDE_PBC_INPUT_DATA_H_
