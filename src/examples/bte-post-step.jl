...
@callbackFunction(
function update_temperature_omega(temperature, temperatureLast, I, beta, center_freq, delta_freq, polarizations, G_last, G_next, vg, Io, g20xi, g20wi, ndirs, nbands, dt, cell, omega)
    temperatureLast[cell] = temperature[cell]

    for band = 1:nbands
        G_next[band, cell] = 0.0
        for dir = 1:ndirs
            G_next[band, cell] += I[(band-1)*ndirs+dir, cell] * omega[dir]
        end
    end
